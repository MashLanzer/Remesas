...
import { Inbox, Truck, Wallet, type LucideIcon } from "lucide-react";
import { PaperPlane } from "@/components/paper-plane";
import { cn } from "@/lib/utils";

const KEY = "giro_r_welcomed";
...
const SLIDES: {
...
}[] = [
  {
    ...
    desc: "Las solicitudes de tus clientes llegan a Pedidos. Acéptalas para empezar el reparto.",
  },
  {
    Icon: Truck,
    anim: "giroTruck 1.4s ease-in-out infinite",
    title: "Entrega y confirma",
    desc: "Marca “en camino”, entrega a la familia y sube la foto de comprobante.",
  },
  {
    Icon: Wallet,
    anim: "giroRocket 1.6s ease-in-out infinite",
    title: "Cobra tu parte",
    desc: "Cada entrega suma tu ganancia. Avísale al operador cuando quieras liquidar.",
  },
];

export function RepartidorOnboarding() {
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-8 text-center">
        ...
        <div key={i} className="animate-fade-up">
          <span className="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl bg-white/15 backdrop-blur">
            <slide.Icon className="h-9 w-9" style={{ animation: slide.anim }} />
          </span>
